...
static constexpr auto qt_meta_stringdata_ZN8TextEditE = QtMocHelpers::stringData(
    "TextEdit",
    "fileNameChanged",
    "",
    "fileName"
...
Q_CONSTINIT static const uint qt_meta_data_ZN8TextEditE[] = {
...
Q_CONSTINIT const QMetaObject TextEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8TextEditE.offsetsAndSizes,
    qt_meta_data_ZN8TextEditE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8TextEditE_t,
        // Q_OBJECT / Q_GADGET
...
void TextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TextEdit::*)(const QString & );
            if (_q_method_type _q_method = &TextEdit::fileNameChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TextEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8TextEditE.stringdata0))
...
// SIGNAL 0
void TextEdit::fileNameChanged(const QString & _t1)
{
